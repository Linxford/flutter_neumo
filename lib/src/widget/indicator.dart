...
/// A Style to customize the [NeumoIndicator]
///
...
enum NeumoIndicatorOrientation { vertical, horizontal }

/// An indicator is a horizontal / vertical bar that display a percentage
///
/// Like a ProgressBar, but with an [orientation] @see [NeumoIndicatorOrientation]
///
...
///
@immutable
class NeumoIndicator extends StatefulWidget {
  final double percent;
  final double width;
  final double height;
  final EdgeInsets padding;
  final NeumoIndicatorOrientation orientation;
  ...
  const NeumoIndicator({
    super.key,
    this.percent = 0.5,
    this.orientation = NeumoIndicatorOrientation.vertical,
  ...
  @override
  createState() => _NeumoIndicatorState();
...
class _NeumoIndicatorState extends State<NeumoIndicator>
  ...
  @override
  void didUpdateWidget(NeumoIndicator oldWidget) {
        ...
        child: AnimatedBuilder(
            ...
            builder: (_, __) {
              return FractionallySizedBox(
                heightFactor:
                    widget.orientation == NeumoIndicatorOrientation.vertical
                        ? _animation.value
                        : 1,
                widthFactor:
                    widget.orientation == NeumoIndicatorOrientation.horizontal
                        ? _animation.value
                        : 1,
                alignment:
                    widget.orientation == NeumoIndicatorOrientation.horizontal
