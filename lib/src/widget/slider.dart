...
typedef NeumoSliderListener = void Function(double percent);
...
///
@immutable
class NeumoSlider extends StatefulWidget {
  final SliderStyle style;
  final double min;
  final double value;
  final double max;
  final double height;
  final NeumoSliderListener? onChanged;
  final NeumoSliderListener? onChangeStart;
  final NeumoSliderListener? onChangeEnd;
  ...
  @override
  createState() => _NeumoSliderState();
}

class _NeumoSliderState extends State<NeumoSlider> {
  @override
