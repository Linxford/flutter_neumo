...
///),
@immutable
class NeumoToggle extends StatelessWidget {
  ...
  const NeumoToggle({
    this.style = const NeumoToggleStyle(),
    super.key,
      ...
      children: [
        ...
        AnimatedAlign(
          ...
          child: FractionallySizedBox(
            ...
            child: Neumo(
              style: NeumoStyle(
                boxShape: NeumoBoxShape.roundRect(style?.borderRadius ??
  ...
  Widget _background(BuildContext context) {
    return Neumo(
      style: NeumoStyle(
          ...
          border: style?.border ?? const NeumoBorder.none(),
          lightSource: style?.lightSource ??
              NeumoTheme.currentTheme(context).lightSource),
  ...
  double _getTrackDepth(BuildContext context) {
    ...
    return depth.clamp(Neumo.MIN_DEPTH, NeumoToggle.MIN_EMBOSS_DEPTH);
  }
