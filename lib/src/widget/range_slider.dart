...
typedef NeumoRangeSliderLowListener = void Function(double percent);
typedef NeumoRangeSliderHighListener = void Function(double percent);

/// A style to customize the [NeumoSlider]
///
...
///
@immutable
class NeumoRangeSlider extends StatefulWidget {
  ...
  final NeumoRangeSliderLowListener? onChangedLow;
  final NeumoRangeSliderHighListener? onChangeHigh;
  final Function(ActiveThumb)? onPanStarted;
  final Function(ActiveThumb)? onPanEnded;
  final Widget? thumb;

  const NeumoRangeSlider({
    super.key,
  ...
  @override
  createState() => _NeumoRangeSliderState();
}

class _NeumoRangeSliderState extends State<NeumoRangeSlider> {
