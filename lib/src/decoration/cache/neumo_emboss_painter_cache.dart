...
class NeumoEmbossPainterCache extends AbstractNeumoEmbossPainterCache {
  @override
  Color generateShadowDarkColor(
      {required Color color, required double intensity}) {
    return NeumoColors.embossDarkColor(
      color,
      intensity: intensity,
    );
  }
  ...
  Color generateShadowLightColor(
      {required Color color, required double intensity}) {
    return NeumoColors.embossWhiteColor(
      color,
      intensity: intensity,
    );
  }
