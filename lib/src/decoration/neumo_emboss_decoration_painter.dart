...
import 'cache/neumo_emboss_painter_cache.dart';

export '../theme/theme.dart';

class NeumoEmbossDecorationPainter extends BoxPainter {
  final NeumoEmbossPainterCache _cache;
  ...
  NeumoEmbossDecorationPainter(
      {required this.style,
      required this.drawBackground,
      required this.drawShadow,
      required VoidCallback onChanged,
      NeumoBoxShape? shape})
      : shape = shape ?? const NeumoBoxShape.rect(),
        _cache = NeumoEmbossPainterCache(),
        super(onChanged) {
    _generatePainters();
  }
