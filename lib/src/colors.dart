...
/// Defines default colors used in Neumo theme & shadows generators
@immutable
class NeumoColors {
  ...
  static Color gradientShaderDarkColor({required double intensity}) {
    // intensity act on opacity;
    return _applyPercentageOnOpacity(
        maxColor: NeumoColors._gradientShaderDarkColor, percent: intensity);
  }

  static Color gradientShaderWhiteColor({required double intensity}) {
    // intensity act on opacity;
    return _applyPercentageOnOpacity(
        maxColor: NeumoColors._gradientShaderWhiteColor, percent: intensity);
  }
